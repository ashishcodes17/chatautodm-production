...
{/* </div> */}
    ...
    <section>
      ...
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-10">
          Why Choose <span className="text-purple-400">ChatAutoDM</span> over Zorcha?
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition text-left">
            ...
            <div className="mb-3 w-8 h-8 bg-red-500/30 rounded flex items-center justify-center">
              ...
              <img src='/zorchalogo.png' alt='ManyChat Logo' className='w-8 h-8 rounded'/>
            </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition text-left">
            ...
            <p className="text-zinc-400">
              Zorcha often charges extra for automation features that 
              ChatAutoDM includes by default.
            </p>
          </div>
 ...
 rounded-2xl p-6 shadow-lg hover:shadow-xl transition text-left">
            ...
            <p className="text-white/90">
              Offers enterprise-level automation and integrations at a 
              fraction of Zorcha’s cost. Perfect for startups & scaling brands.
            </p>
          </div>
      ...
      <section id="comparison" className="py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">See how ChatAutoDM stacks up against Zorcha</p>
          </div>
              ...
              <div className="p-6 text-center border-l border-border">
                <div className="flex items-center justify-center space-x-2">
                  <div className="w-6 h-6 bg-foreground rounded flex items-center justify-center">
                     <img src="/zorchalogo.png" className='corner round' />
                  </div>
                  <span className="font-semibold">Zorcha</span>
                </div>
              </div>
            </div>
